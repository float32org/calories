...
<svelte:head>
	<title>Settings - Desktop</title>
	<meta name="description" content="Manage your account and security settings" />
	<meta name="robots" content="noindex" />
</svelte:head>

<div class="mx-auto max-w-3xl pt-12 pb-8 md:pb-12">
	<div class="flex items-center justify-between px-4 pb-6 sm:px-6 md:pb-8">
	...
	<div class="space-y-4 px-4 pb-8 sm:px-6 md:space-y-5 md:pb-12">
		<Card>
			<CardHeader>
				...
				{#if sortedSessions.length}
					<div class="space-y-2 md:space-y-2.5">
						{#each sortedSessions as session (session.id)}
							...
							<div
								class="group bg-card/50 hover:bg-card/80 relative rounded-xl border p-3 transition-colors md:p-3.5"
							>
								<div class="flex items-center justify-between">
									<div class="flex min-w-0 flex-1 items-center gap-3 md:gap-3.5">
									...
									{#if session.id !== data.session?.id}
										...
										>
											<XCircleIcon class="mr-1 size-3.5" />
